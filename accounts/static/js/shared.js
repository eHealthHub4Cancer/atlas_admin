(() => {
  ...
  // Theme toggle functionality - works for both old and new toggle buttons
  ...
  // Password toggle functionality - supports both old (.input-button) and new (.toggle-password) classes
    ...
    button.addEventListener("click", () => {
      ...
      if (icon) {
        icon.innerHTML = isPassword
          ? '<path d="M2.1 12c1.6-4.4 5.8-7.5 10.4-7.5 4.6 0 8.8 3.1 10.4 7.5-1.6 4.4-5.8 7.5-10.4 7.5-4.6 0-8.8-3.1-10.4-7.5z" stroke="currentColor" stroke-width="1.5" fill="none"/><circle cx="12.5" cy="12" r="3.2" stroke="currentColor" stroke-width="1.5" fill="none"/><line x1="4" y1="4" x2="20" y2="20" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>'
